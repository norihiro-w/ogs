...
public:
    ...
    FluidSpecificHeat(Type type, std::vector<double> &parameters)
...
//            int gueltig;
        ...
        {
            density = SalineWaterSpecificHeat_IAPWS_IF97(variables->p,variables->T,variables->C);
            break;
        }
        case Type::Linear:
            {
