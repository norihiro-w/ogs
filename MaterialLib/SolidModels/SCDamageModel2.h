...
class SCDamageModel2 final : public MechanicsBase<DisplacementDim>
{
public:
    ...
    {
        return ConstitutiveModel::SCDamageModel2;
    }
...
extern template class SCDamageModel2<2>;
extern template class SCDamageModel2<3>;
