# THM; Small deformation, linear poroelastic, homogeneous
AddTest(
    NAME THM_square_1e0
    PATH THM/Linear/Square_sealed_homogeneous
    EXECUTABLE ogs
...
# THM; Small deformation, linear poroelastic, sealed, bimaterial
AddTest(
    NAME THM_square_1e2_sealed_bimaterial
    PATH THM/Linear/Beam_sealed_bimaterial
    EXECUTABLE ogs
...
# THM; Small deformation, linear poroelastic, unsealed, bimaterial
AddTest(
    NAME THM_square_1e2_unsealed_bimaterial
    PATH THM/Linear/Beam_unsealed_bimaterial
    EXECUTABLE ogs
    EXECUTABLE_ARGS square_1e2.prj
    WRAPPER time
    TESTER vtkdiff
...
# THM; Small deformation, linear poroelastic, point heat source consolidation
AddTest(
    NAME THM_square_1e2_point_heat_injection
    PATH THM/Linear/Point_injection
    EXECUTABLE ogs
    EXECUTABLE_ARGS square_1e2.prj
    WRAPPER time
    TESTER vtkdiff
