...
#include "LIEGenericNaturalBoundaryCondition.h"
#include "LIENeumannBoundaryConditionLocalAssembler.h"
...
using NeumannBoundaryCondition =
    LIEGenericNaturalBoundaryCondition<GlobalDim, ParameterLib::Parameter<double> const&,
                                    LIENeumannBoundaryConditionLocalAssembler>;

template <unsigned GlobalDim>
std::unique_ptr<NeumannBoundaryCondition<GlobalDim>> createNeumannBoundaryCondition(
    ...
    std::vector<unsigned> const& frac_ids)
{
    ...
    return std::make_unique<NeumannBoundaryCondition<GlobalDim>>(
