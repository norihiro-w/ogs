...
namespace LIE
{
template <unsigned GlobalDim, typename BoundaryConditionData,
          template <typename, typename, unsigned>
          class LocalAssemblerImplementation>
template <typename Data>
LIEGenericNaturalBoundaryCondition<GlobalDim, BoundaryConditionData,
                                LocalAssemblerImplementation>::
    LIEGenericNaturalBoundaryCondition(
...
template <unsigned GlobalDim, typename BoundaryConditionData,
          template <typename, typename, unsigned>
          class LocalAssemblerImplementation>
void LIEGenericNaturalBoundaryCondition<
    GlobalDim, BoundaryConditionData,
